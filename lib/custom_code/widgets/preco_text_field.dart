...
class PrecoTextField extends StatefulWidget {
  const PrecoTextField({
    Key? key,
    this.width,
    this.height,
    this.value,
  ...
  @override
  _PrecoTextFieldState createState() => _PrecoTextFieldState();
}

class _PrecoTextFieldState extends State<PrecoTextField> {
  @override
