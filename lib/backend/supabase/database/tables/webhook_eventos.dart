...
class WebhookEventosTable extends SupabaseTable<WebhookEventosRow> {
  @override
  String get tableName => 'webhook_eventos';

  @override
  WebhookEventosRow createRow(Map<String, dynamic> data) =>
      WebhookEventosRow(data);
}

class WebhookEventosRow extends SupabaseDataRow {
  WebhookEventosRow(super.data);

  @override
  SupabaseTable get table => WebhookEventosTable();
