...
class DadosUserWidget extends StatefulWidget {
  const DadosUserWidget({super.key});

  @override
  State<DadosUserWidget> createState() => _DadosUserWidgetState();
}
